...
public class PersonJpaController implements Serializable {
    ...
    private static PersonJpaController instance;
    
    public static PersonJpaController getInstance(){
        if(instance == null){
            instance = new PersonJpaController(Persistence.createEntityManagerFactory("com.mycompany_hibernateAutoGenerated_jar_1.0-SNAPSHOTPU"));
        }
        return instance;
    }
