 ...
 * @author manuelmsni
 */
public class Ej2VistaSevidor extends javax.swing.JFrame {

    /**
     * Creates new form VistaEj2
     */
    public Ej2VistaSevidor() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ej2VistaSevidor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ej2VistaSevidor().setVisible(true);
            }
        });
    }
