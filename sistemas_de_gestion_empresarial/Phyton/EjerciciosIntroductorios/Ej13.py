...
interes = 0.04
print("Tu capital obtenido es: " + str(round(cantidad * (interes + 1), 2)))
print("Tu capital obtenido es: " + str(round(cantidad * (interes + 1) ** 2, 2)))
print("Tu capital obtenido es: " + str(round(cantidad * (interes + 1) ** 3, 2)))
